...
# Author: Hacker Vai.
# GitHub: https://github.com/error404bd
# Version: 5.1.0
#########################################
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Hacker  Vai.                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/error404bd/ \033[94m│".center(columns+9))
